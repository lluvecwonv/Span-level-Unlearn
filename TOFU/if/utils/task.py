...
class LanguageModelingTask(Task):
    ...
    def get_influence_tracked_modules(self) -> List[str]:
        ...
        if family == "pythia":
        ...
        elif family in ["llama2-7b", "llama-3", "llama3-8b", "qwen2.5-7b", "qwen"]:
            # Llama 2, Llama 3, and Qwen2.5 share the same module structure.
            for i in range(num_layers):
                total_modules.extend([
            ...
            # Phi uses a different module structure from LLaMA (fc1, fc2, dense).
            for i in range(num_layers):
                total_modules.extend([
